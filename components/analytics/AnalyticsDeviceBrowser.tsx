...
export const AnalyticsDeviceBrowser: React.FC = () => {
  const { t } = useLanguage();
  ...
  const handleDeviceClick = (device: Device) => {
    setSelectedDeviceId(device.device_id_unik);
  };
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-lg border border-gray-200 shadow-sm">
              <div className="p-4 border-b border-gray-200 bg-gradient-to-r from-purple-50 to-purple-100">
                <h2 className="text-xl font-bold text-gray-900">{selectedDevice.device_id_unik}</h2>
                <p className="text-sm text-gray-600 mt-1">
                  {t('deviceId')}: {selectedDevice.device_id_unik}
                </p>
              </div>
              ...
              <div className="p-4 space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-900 mt-1">{selectedDevice.tipe_alat || t('notAvailable')}</p>
                  </div>
                  <div>
          ...
          {devices.map((device) => (
            ...
            >
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <h4 className="text-sm font-semibold text-gray-900 font-mono">{device.device_id_unik}</h4>
